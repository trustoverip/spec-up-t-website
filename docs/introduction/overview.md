...
- You can edit files using:
  ...
  3. **The Spec-Up-T Editor** - a dedicated web application with advanced features ([launch](https://app.blockchainbird.org) | [learn more](/docs/getting-started/spec-up-t-editor/user-guide))

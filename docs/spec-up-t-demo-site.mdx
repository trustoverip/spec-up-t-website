...
First, the [GitHub repo of the demo Spec-Up-T](https://github.com/trustoverip/spec-up-t-demo-on-documentation-website).
...
[![Alt text](/img/spec-up-t-demo-screenshot.jpg)](https://trustoverip.github.io/spec-up-t-demo-on-documentation-website/)
</div>
...
|-|-|-|
|`/index.html`|Current version|[LINK](https://trustoverip.github.io/spec-up-t-demo-on-documentation-website/)|
|`/versions/index-v1.html`|4 terms in total|[LINK](https://trustoverip.github.io/spec-up-t-demo-on-documentation-website/versions/index-v1.html)|
|`/versions/index-v2.html`|Term 5 added|[LINK](https://trustoverip.github.io/spec-up-t-demo-on-documentation-website/versions/index-v2.html)|
|`/versions/index-v3.html`|Term 5 definition changed|[LINK](https://trustoverip.github.io/spec-up-t-demo-on-documentation-website/versions/index-v3.html)|
|`/versions/index-v4.html`|Term 6 added, same as current|[LINK](https://trustoverip.github.io/spec-up-t-demo-on-documentation-website/versions/index-v4.html)|
</div>

Snapshots can be taken via the “freeze” option in Spec-Up-T's [start menu](user-interface-overview/command-line-menu).
